> **Versión 2026-Q1** — copia del prototipo con la paleta primaria en **verde**
> (`#0e9f6e`) en lugar del morado original, para distinguirla de un vistazo.
> El resto del código es idéntico a [`recruitment-tracker/`](../../recruitment-tracker/).
...
| Token | Valor | Uso |
|---|---|---|
| `--color-primary` | `#0e9f6e` | Botones, links, estado activo — verde de esta versión |
