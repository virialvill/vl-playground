> **Versión 2026-Q3** — copia del prototipo con la paleta primaria en **azul**
> (`#2563eb`) en lugar del morado original, para distinguirla de un vistazo.
...
| Token | Valor | Uso |
|---|---|---|
| `--color-primary` | `#2563eb` | Botones, links, estado activo — azul de esta versión |
